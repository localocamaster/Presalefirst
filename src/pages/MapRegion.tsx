...
const plans = [
  ...
  },
  {
    ...
    features: ['전화 상담 버튼', '카톡 상담 연결', '유튜브 영상 (최대 2개)', '오시는 길 + 약도 전송', '팝업 (최대 10개)', '파비콘', '호스팅 무료', '기본 도메인 무료', '파워링크 조건 충족', '관심고객 관리', '접속통계', '부정클릭 차단'],
    disabled: [],
  },
];
...
const highlights = [
  ...
  { icon: Shield, title: '부정클릭 차단', desc: '광고비 낭비를 막아줍니다' },
